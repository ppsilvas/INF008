...
public class Product implements Serializable {
    ...
    public static void getLowestInventory(){
        ...
        System.out.println("["+lowestInventory.id+"] - Name: "+lowestInventory.name+"- Total:"+lowestInventory.totalInInventory+"- Description:"+lowestInventory.description+"- Price:"+lowestInventory.price+ "- Category:"+lowestInventory.category);
    }
